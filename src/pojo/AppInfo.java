...
public class AppInfo {
	...
	public String toString() {
		return "AppInfo [APKName=" + APKName + ", categoryLevel3=" + categoryLevel3 + ", flatformId=" + flatformId
				+ ", flatformName=" + flatformName + ", categoryLevel3Name=" + categoryLevel3Name + ", categoryLevel1="
				+ categoryLevel1 + ", categoryLevel2=" + categoryLevel2 + ", categoryLevel1Name=" + categoryLevel1Name
